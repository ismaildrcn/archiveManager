...
"}")
        ...
        self.pushButton_compress_extract = QtWidgets.QPushButton(self.widget_6)
        self.pushButton_compress_extract.setEnabled(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/de-compress.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_compress_extract.setIcon(icon)
        self.pushButton_compress_extract.setIconSize(QtCore.QSize(28, 28))
        self.pushButton_compress_extract.setObjectName("pushButton_compress_extract")
        self.horizontalLayout_3.addWidget(self.pushButton_compress_extract)
        ...
        self.pushButton_add_folder.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/add-database-script.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/nav-arrow-left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/icons/nav-arrow-right.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
